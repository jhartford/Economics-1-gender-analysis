...
stargazer(mod.lm2012,mod.lm2013, mod.combined, 
          ...
          covariate.labels=c("Sex - Male","Negative Marking","Race \\& Chinese",
                             "Race \\& Coloured","Race \\& Indian","Race \\& White",
                             "Matric Maths Average","Age","Male Negative Marking","Constant")) 
@
...
stargazer(mod.combined.full, 
          ...
          covariate.labels=c("Sex - Male","Negative Marking","Race - Chinese",
                             "Race - Coloured","Race - Indian","Race - White",
                             "Matric Maths Average","Age","Negative Marking \\& Male",
...
stargazer(mod.melted, title="Melted Regression Results",dep.var.labels = c("Left Question Blank"),covariate.labels=c("Matric Average", "Test 1 Mark", "Sex - Male", "Constant")) 
@
